...
class CSPManager:
    ...
    def init_app(self, app):
        ...
        # Check if in development mode (either app.debug=True,
        # FLASK_ENV=development, or FLASK_DEBUG=1)
        is_debug = app.debug or os.getenv(
            'FLASK_ENV') == 'development' or os.getenv('FLASK_DEBUG') == '1'
        ...
        if is_debug:
            ...
            @app.before_request
            def generate_nonce_disabled():
                g.csp_nonce = secrets.token_urlsafe(16)

            @app.context_processor
            def inject_csp_nonce_disabled():
                return {
    ...
    def build_policy(self, nonce=None):
        ...
        if nonce:
            directives.append(
                f"script-src 'self' 'nonce-{nonce}' 'unsafe-inline' 'unsafe-hashes' "
        ...
        # Embedded media frames (YouTube/Vimeo/PeerTube)
        directives.append(
            "frame-src 'self' https://www.youtube-nocookie.com https://www.youtube.com "
            "https://player.vimeo.com https://vimeo.com https://framatube.org "
            "https://peertube.social https://video.ploud.fr https://tube.tchncs.de")
