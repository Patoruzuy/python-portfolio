...
from app.utils.rate_limiter import init_limiter, create_rate_limit_error_handler
...
def create_app(config_name: Optional[str] = None) -> Flask:
    ...
    # Keep instance/ at project root (not inside the app/ package)
    import os as _os
    _project_root = _os.path.dirname(_os.path.dirname(_os.path.abspath(__file__)))
    app = Flask(__name__, instance_path=_os.path.join(_project_root, "instance"))
