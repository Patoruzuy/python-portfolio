...
from app.routes.admin.blog import admin_blog_bp
from app.routes.admin.newsletter import admin_newsletter_bp
...
from app.routes.admin.media import admin_media_bp
